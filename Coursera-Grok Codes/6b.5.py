...
def rf_predict_actual(data, n_estimators):
  ...
  input_features, output_targets = generate_features_targets(data)
  # instantiate a random forest classifier using n estimators
  rfc = RandomForestClassifier(n_estimators=n_estimators)
  # get predictions using 10-fold cross validation with cross_val_predict
  predictions = cross_val_predict(rfc, input_features, output_targets, cv=10)
  # return the predictions and their actual classes
  return predictions,output_targets
